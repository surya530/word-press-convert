...
import { stampCatalogueCaseStudyTranslations } from '../translations/stampCatalogueCaseStudy'

export default function StampCatalogueCaseStudyPage() {
  const dispatch = useAppDispatch()
  const location = useLocation()
  const language = useAppSelector((state) => state.language.current)
  const t = stampCatalogueCaseStudyTranslations[language]
